...
export default function AdvancedFilters({
  filterConfig,          // Configuração dos filtros disponíveis
  filters,               // Estado atual dos filtros
  onFiltersChange,       // Callback quando filtros mudam
  savedFiltersKey,       // Chave para guardar/carregar filtros (ex: "properties", "opportunities")
  totalCount,            // Total de itens
  filteredCount,         // Itens após filtragem
  ...
  const [filterLogic, setFilterLogic] = React.useState("AND"); // "AND" ou "OR"
  ...
  // Renderizar um filtro baseado no seu tipo
  ...
  // Separar filtros básicos e avançados
...
// Exportar tipos de filtros para uso externo
export { FILTER_TYPES };