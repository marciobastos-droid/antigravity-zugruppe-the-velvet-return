...
import { Home, Plus, LayoutDashboard, MessageSquare, Building2, Users, Menu, X, Wrench, BarChart3 } from "lucide-react";
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50 backdrop-blur-lg bg-white/95">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center h-16 md:h-20">
            <Link to={createPageUrl("Browse")} className="flex items-center gap-2 md:gap-3 group flex-shrink-0">
              <img
