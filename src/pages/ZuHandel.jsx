...
export default function ZuHandel() {
  ...
  const COMMERCIAL_TYPES = ['store', 'warehouse', 'office', 'building', 'land'];
  ...
  const publishedProperties = properties.filter(p => {
    ...
    const isPublishedInZuHandel = (p.published_pages || []).includes('zuhandel');
    return isActive && isCommercial && isPublishedInZuHandel;
  });
  ...
  const filteredProperties = publishedProperties.filter((property) => {
    ...
    return matchesSearch && matchesListingType && matchesPropertyType && matchesCity && 
           matchesPrice && matchesCountry && matchesDistrict;
  });
  ...
  React.useEffect(() => {
    setCurrentPage(1);
  }, [listingType, propertyType, city, priceRange, sortBy, country, district]);

  if (isLoading) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#75787b] mx-auto mb-4" />
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#000000] via-[#2a2a2a] to-[#75787b]">
        <div className="absolute inset-0 bg-cover bg-center opacity-20 bg-[url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1600')]" />
      ...
      {/* Contact CTA */}
      <div className="py-12 bg-gradient-to-r from-[#75787b] to-[#5a5c5e]">
