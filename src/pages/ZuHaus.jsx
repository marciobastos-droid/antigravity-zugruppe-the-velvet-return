...
export default function ZuHaus() {
  ...
  const handlePropertyContact = (property) => {
    ...
    setContactForm(prev => ({
      ...prev,
      message: `Estou interessado no imóvel "${property.title}" - Ref: ${property.ref_id || property.id}`
    }));
    ...
    <div className="min-h-screen bg-white">
      ...
      <Dialog open={contactDialogOpen} onOpenChange={setContactDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Contacte-nos</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleContactSubmit} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full bg-[#d22630] hover:bg-[#a01d26]"
